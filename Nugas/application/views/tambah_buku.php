...
<body>
	...
	<div class="container" style="margin-top: 80px">
		<div class="col-md-12">
			<?php echo form_open('perpus/simpan_buku') ?>
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" name="th_terbit" class="form-control" placeholder="Masukkan Tahun Terbit">
			  </div>

			  <div class="form-group">
			    <label for="text">ID Kategori</label>
			    <input type="text" name="id_kategori" class="form-control" placeholder="Masukkan ID Kategori">
			  </div>
