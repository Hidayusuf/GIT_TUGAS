...
<head>
  <meta charset="utf-8">
  <title>NUGAS BARENG</title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="">
  <meta name="author" content="">
  <!-- styles -->
  <link href="<?php echo base_url(''); ?>assets2/css/bootstrap.css" rel="stylesheet">
  <link href="<?php echo base_url(''); ?>assets2/css/bootstrap-responsive.css" rel="stylesheet">
  <link href="<?php echo base_url(''); ?>assets2/css/prettyPhoto.css" rel="stylesheet">
  <link href="<?php echo base_url(''); ?>assets2/font/stylesheet.css" rel="stylesheet">
  ...
  <link rel="<?php echo base_url(''); ?>assets2/stylesheet" media="screen" href="<?php echo base_url(''); ?>assets2/css/sequencejs.css">
  <link href="<?php echo base_url(''); ?>assets2/css/style.css" rel="stylesheet">
  <link href="<?php echo base_url(''); ?>assets2/color/default.css" rel="stylesheet">

  <!-- Fav and touch icons -->
  <link rel="<?php echo base_url(''); ?>assets2/apple-touch-icon-precomposed" sizes="144x144" href="<?php echo base_url(''); ?>assets2/ico/apple-touch-icon-144-precomposed.png">
  <link rel="<?php echo base_url(''); ?>assets2/apple-touch-icon-precomposed" sizes="114x114" href="<?php echo base_url(''); ?>assets2/ico/apple-touch-icon-114-precomposed.png">
  <link rel="<?php echo base_url(''); ?>assets2/apple-touch-icon-precomposed" sizes="72x72" href="<?php echo base_url(''); ?>assets2/ico/apple-touch-icon-72-precomposed.png">
  <link rel="<?php echo base_url(''); ?>assets2/apple-touch-icon-precomposed" href="<?php echo base_url(''); ?>assets2/ico/apple-touch-icon-57-precomposed.png">
  <link rel="<?php echo base_url(''); ?>assets2/shortcut icon" href="<?php echo base_url(''); ?>assets2/ico/favicon.ico">
...
<body>
  <header>
    ...
    <div id="topnav" class="navbar navbar-fixed-top default">
      <div class="navbar-inner">
        <div class="container">
          <div class="logo">
            <a class="brand" href="<?php echo base_url(''); ?>assets2/index.php"><img src="<?php echo base_url(''); ?>assets2/img/logo3.png" alt=""></a>
          </div>
          <div class="navigation">
            <nav>
              <ul class="nav pull-right">
                ...
                <li><a href="<?php echo base_url(''); ?>index.php/perpus/register2"><span class="glyphicon glyphicon-user"></span> Register</a></li>
                <li><a href="<?php echo base_url(''); ?>index.php/perpus/login"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
                    </li>
                  </ul>
                </li>
              </ul>
              ...
              <ul>
                <li class="animate-in">
                  <div class="info letter-container">
                    <h2 class="fade">Welcome To Our Website</h2>
                  </div>
      ...
      <div class="row">
        <div class="span6">
          <div class="flexslider">
            <ul class="slides">
              <li>
                <img src="<?php echo base_url(''); ?>assets2/img/slider/flexslider/img-1.png" alt="">
              </li>
              <li>
                <img src="<?php echo base_url(''); ?>assets2/img/slider/flexslider/img-2.png" alt="">
              </li>
              <li>
                <img src="<?php echo base_url(''); ?>assets2/img/slider/flexslider/img-3.png" alt="">
              </li>
            </ul>
          </div>
        </div>
            ...
            <ul class="portfolio-area">
              <li class="portfolio-item2" data-id="id-0" data-type="web">
                <div class="thumb-wrapp">
                  <img src="<?php echo base_url(''); ?>assets2/img/portfolio/img1.jpg" class="folio-image" alt="">
                  <div class="folio-caption">
                    <h5>Portfolio name</h5>
                    <span class="folio-link">
                  <a href="<?php echo base_url(''); ?>assets2/img/portfolio/big.jpg" data-pretty="prettyPhoto" title="zoom">
              ...
              <li class="portfolio-item2" data-id="id-0" data-type="brand">
                <div class="thumb-wrapp">
                  <img src="<?php echo base_url(''); ?>assets2/img/portfolio/img2.jpg" class="folio-image" alt="">
                  <div class="folio-caption">
                    <h5>Portfolio name</h5>
                    <span class="folio-link">
                  <a href="<?php echo base_url(''); ?>assets2/img/portfolio/big.jpg" data-pretty="prettyPhoto" title="zoom">
              ...
              <li class="portfolio-item2" data-id="id-0" data-type="web">
                <div class="thumb-wrapp">
                  <img src="<?php echo base_url(''); ?>assets2/img/portfolio/img3.jpg" class="folio-image" alt="">
                  <div class="folio-caption">
                    <h5>Portfolio name</h5>
                    <span class="folio-link">
                  <a href="<?php echo base_url(''); ?>assets2/img/portfolio/big.jpg" data-pretty="prettyPhoto" title="zoom">
              ...
              <li class="portfolio-item2" data-id="id-0" data-type="graphic">
                <div class="thumb-wrapp">
                  <img src="<?php echo base_url(''); ?>assets2/img/portfolio/img4.jpg" class="folio-image" alt="">
                  <div class="folio-caption">
                    <h5>Portfolio name</h5>
                    <span class="folio-link">
                  <a href="<?php echo base_url(''); ?>assets2/img/portfolio/big.jpg" data-pretty="prettyPhoto" title="zoom">
              ...
              <li class="portfolio-item2" data-id="id-0" data-type="ilustrator">
                <div class="thumb-wrapp">
                  <img src="<?php echo base_url(''); ?>assets2/img/portfolio/img5.jpg" class="folio-image" alt="">
                  <div class="folio-caption">
                    <h5>Portfolio name</h5>
                    <span class="folio-link">
                  <a href="<?php echo base_url(''); ?>assets2/img/portfolio/big.jpg" data-pretty="prettyPhoto" title="zoom">
              ...
              <li class="portfolio-item2" data-id="id-0" data-type="brand">
                <div class="thumb-wrapp">
                  <img src="<?php echo base_url(''); ?>assets2/img/portfolio/img6.jpg" class="folio-image" alt="">
                  <div class="folio-caption">
                    <h5>Portfolio name</h5>
                    <span class="folio-link">
                  <a href="<?php echo base_url(''); ?>assets2/img/portfolio/big.jpg" data-pretty="prettyPhoto" title="zoom">
              ...
              <li class="portfolio-item2" data-id="id-0" data-type="photo">
                <div class="thumb-wrapp">
                  <img src="<?php echo base_url(''); ?>assets2/img/portfolio/img7.jpg" class="folio-image" alt="">
                  <div class="folio-caption">
                    <h5>Portfolio name</h5>
                    <span class="folio-link">
                  <a href="<?php echo base_url(''); ?>assets2/img/portfolio/big.jpg" data-pretty="prettyPhoto" title="zoom">
              ...
              <li class="portfolio-item2" data-id="id-0" data-type="photo">
                <div class="thumb-wrapp">
                  <img src="<?php echo base_url(''); ?>assets2/img/portfolio/img8.jpg" class="folio-image" alt="">
                  <div class="folio-caption">
                    <h5>Portfolio name</h5>
                    <span class="folio-link">
                  <a href="<?php echo base_url(''); ?>assets2/img/portfolio/big.jpg" data-pretty="prettyPhoto" title="zoom">
              ...
              <li class="portfolio-item2" data-id="id-0" data-type="brand">
                <div class="thumb-wrapp">
                  <img src="<?php echo base_url(''); ?>assets2/img/portfolio/img9.jpg" class="folio-image" alt="">
                  <div class="folio-caption">
                    <h5>Portfolio name</h5>
                    <span class="folio-link">
                  <a href="<?php echo base_url(''); ?>assets2/img/portfolio/big.jpg" data-pretty="prettyPhoto" title="zoom">
              ...
              <li class="portfolio-item2" data-id="id-0" data-type="graphic">
                <div class="thumb-wrapp">
                  <img src="<?php echo base_url(''); ?>assets2/img/portfolio/img11.jpg" class="folio-image" alt="">
                  <div class="folio-caption">
                    <h5>Portfolio name</h5>
                    <span class="folio-link">
                  <a href="<?php echo base_url(''); ?>assets2/img/portfolio/big.jpg" data-pretty="prettyPhoto" title="zoom">
              ...
              <li class="portfolio-item2" data-id="id-0" data-type="brand">
                <div class="thumb-wrapp">
                  <img src="<?php echo base_url(''); ?>assets2/img/portfolio/img12.jpg" class="folio-image" alt="">
                  <div class="folio-caption">
                    <h5>Portfolio name</h5>
                    <span class="folio-link">
                  <a href="<?php echo base_url(''); ?>assets2/img/portfolio/big.jpg" data-pretty="prettyPhoto" title="zoom">
  ...
  <script src="<?php echo base_url(''); ?>assets2/js/jquery.easing.js"></script>
  <script src="<?php echo base_url(''); ?>assets2/js/bootstrap.js"></script>
  <script src="<?php echo base_url(''); ?>assets2/js/jquery.lettering.js"></script>
  <script src="<?php echo base_url(''); ?>assets2/js/parallax/jquery.parallax-1.1.3.js"></script>
  <script src="<?php echo base_url(''); ?>assets2/js/nagging-menu.js"></script>
  <script src="<?php echo base_url(''); ?>assets2/js/sequence.jquery-min.js"></script>
  <script src="<?php echo base_url(''); ?>assets2/js/sequencejs-options.sliding-horizontal-parallax.js"></script>
  <script src="<?php echo base_url(''); ?>assets2/js/portfolio/jquery.quicksand.js"></script>
  <script src="<?php echo base_url(''); ?>assets2/js/portfolio/setting.js"></script>
  <script src="<?php echo base_url(''); ?>assets2/js/jquery.scrollTo.js"></script>
  <script src="<?php echo base_url(''); ?>assets2/js/jquery.nav.js"></script>
  <script src="<?php echo base_url(''); ?>assets2/js/modernizr.custom.js"></script>
  <script src="<?php echo base_url(''); ?>assets2/js/prettyPhoto/jquery.prettyPhoto.js"></script>
  <script src="<?php echo base_url(''); ?>assets2/js/prettyPhoto/setting.js"></script>
  <script src="<?php echo base_url(''); ?>assets2/js/jquery.flexslider.js"></script>
